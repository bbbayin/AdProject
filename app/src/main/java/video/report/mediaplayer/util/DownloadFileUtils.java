...
public class DownloadFileUtils {
     ...
     * @return
     * @throws DownloadException ExceptionCode.TargetFilePathIsPlacedByDir
     ...
     * @return
     * @throws DownloadException ExceptionCode.TargetDirPathIsPlacedByFile
     ...
     */
    public static boolean mkdirsAdvanced(File dirFile) {

        if (DownloadEnvironment.getSdkVersion() >= DownloadEnvironment.ANDROID_4_4_2
                && MyApplication.getInstance() instanceof ContextWrapper) {
            try {
                ContextWrapper contextWrapper = (ContextWrapper) MyApplication.getInstance();
