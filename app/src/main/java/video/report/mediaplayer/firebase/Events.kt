...
object Events {
    ...
    const val AD_APPEXIT_ADSHOW_VUNGLE = "ad_appexit_adshow_vungle"
    const val AD_APPEXIT_ADSHOW_APPLOVIN = "ad_appexit_adshow_applovin"
    const val AD_APPEXIT_ADSHOW_ADCOLONY = "ad_appexit_adshow_adcolony"
    ...
    const val AD_DOWNLOADSTAB_ADSHOW_VUNGLE = "ad_downloadstab_adshow_vungle"
    const val AD_DOWNLOADSTAB_ADSHOW_APPLOVIN = "ad_downloadstab_adshow_applovin"
    const val AD_DOWNLOADSTAB_ADSHOW_ADCOLONY = "ad_downloadstab_adshow_adcolony"
    ...
    const val AD_VIDEOEXIT_ADSHOW_VUNGLE = "ad_videoexit_adshow_vungle"
    const val AD_VIDEOEXIT_ADSHOW_APPLOVIN = "ad_videoexit_adshow_applovin"
    const val AD_VIDEOEXIT_ADSHOW_ADCOLONY = "ad_videoexit_adshow_adcolony"
    ...
    const val AD_TAB_ADSHOW_VG = "ad_tab_adshow_vungle"
    const val AD_TAB_ADSHOW_APPLOVIN = "ad_tab_adshow_applovin"
    const val AD_TAB_ADSHOW_ADCOLONY = "ad_tab_adshow_adcolony"
