...
package video.report.mediaplayer.exten
...
import video.report.mediaplayer.ui.widget.ToastCompat
 ...
 */
inline fun Context.toast(@StringRes stringRes: Int) = ToastCompat.makeText(this, stringRes, Toast.LENGTH_SHORT).show()

inline fun Context.longtoast(@StringRes stringRes: Int) = ToastCompat.makeText(this, stringRes, Toast.LENGTH_SHORT).show()
