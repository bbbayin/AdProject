...
import static miku.ad.AdConstants.AdType;
import static miku.ad.AdConstants.DEBUG;
...
public class MopubNativeAdapter extends AdAdapter {
    ...
    private final static String TAG = "MopubNativeAdapter";

    public MopubNativeAdapter(Context context, String adUnit, String slot) {
    ...
    public void loadAd(Context context, int num, IAdLoadListener listener) {
        ...
        moPubNative = new MoPubNative(context, this.adUnit, new MoPubNative.MoPubNativeNetworkListener() {
            ...
            public void onNativeLoad(NativeAd nativeAd) {
                ...
                mStartLoadedTime = 0;
                MopubNativeAdapter.this.onAdLoaded();
            }
            ...
            public void onNativeFail(NativeErrorCode errorCode) {
                ...
                stopMonitor();
                mStartLoadedTime = 0;
                MopubNativeAdapter.this.onError(String.valueOf(errorCode));
            }
        });
    ...
    public View getAdView(Context context, AdViewBinder viewBinder) {
        final ViewBinder mpViewBinder = new ViewBinder.Builder(viewBinder.layoutId)
                ...
                .privacyInformationIconImageId(viewBinder.privacymopubInformationId)
        ...
        rawAd.setMoPubNativeEventListener(new NativeAd.MoPubNativeEventListener() {
            @Override
            ...
            public void onClick(View view) {
                FuseAdLoader.reportAdClick(MopubNativeAdapter.this);
            }
        });
        ...
        MopubNativeAdapter.this.onAdShowed();
        return adview;
    }
